...
export class ExportService {
  ...
  async writeJsonl(item: Uoc) {
    // Write to JSONL (append only - deduplication happens at read time)
    // This avoids race conditions where multiple threads try to rewrite the file simultaneously
